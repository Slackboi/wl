...
window.boot = function () {
  ...
  if (false) {
    ...
    var bundledScript = 'https://cdn.jsdelivr.net/gh/Slackboi/wl/src/project.min.js?ran=' + Math.random().toString("32").substring(2);
    if (jsList) {
      jsList = jsList.map(function (x) {
        return 'https://cdn.jsdelivr.net/gh/Slackboi/wl/src/' + x;
      });
  ...
  cc.AssetLibrary.init({
    libraryPath: 'https://cdn.jsdelivr.net/gh/Slackboi/wl/res/import',
    rawAssetsBase: 'https://cdn.jsdelivr.net/gh/Slackboi/wl/res/raw-',
...
if (false) {
  BK.Script.loadlib('GameRes:https://cdn.jsdelivr.net/gh/Slackboi/wl/src/settings.js');
  BK.Script.loadlib();
...
>>>>>>> 82d0ff7218bd8f84588749e9dc7baf2cd5b52c3d
    ...
    require('https://cdn.jsdelivr.net/gh/Slackboi/wl/src/settings');
    require('https://cdn.jsdelivr.net/gh/Slackboi/wl/src/cocos2d-jsb.js');
